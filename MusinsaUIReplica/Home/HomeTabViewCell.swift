...
class HomeTabViewCell: UICollectionViewCell {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(SaleCell1.self, forCellWithReuseIdentifier: "SaleCell1")
        collectionView.register(SaleCellItem.self, forCellWithReuseIdentifier: "SaleCellItem")
        collectionView.register(SaleCellItemHeaer.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "SaleCellItemHeaer")
